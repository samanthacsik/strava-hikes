...
map <- leaflet() %>% 
  ...
  addMarkers(data = hike_data, icon = hiker_icon_custom, group = "Display Hike Icons",
  ...
  addMarkers(data = ride_data, icon = bike_icon_custom, group = "Display Bike Ride Icons",
             lng = ~jitter(lng, factor = 6), lat = ~jitter(lat, factor = 6),
  ...
  addMarkers(data = walk_data, icon = walk_icon_custom, group = "Display Walk Icons",
             lng = ~jitter(lng, factor = 6), lat = ~jitter(lat, factor = 6),
...
#............................save map............................
saveWidget(map,
           file = "maps/sams_activity_map_20220604.html",
           selfcontained = TRUE)
```
